...
module.exports = async (req, res) => {
	try {
		...
		if (req.method === 'PUT') {
			...
			if (req.query?.mine) {
				const data = {};
				for (const k of ['name', 'quantity', 'price', 'old_price', 'shipping_price', 'delivery_days', 'delivery_by_carrier', 'short_description', 'description', 'link', 'visibility', 'neighborhoods', 'images']) {
